...
int chrdev_driver_probe(struct platform_device* pdev)
{
    ...
    ret1 = request_threaded_irq(keydev.key1_interrupts,
                                key_ISR,
                                threaded_irq_functions,
                                IRQF_TRIGGER_RISING | IRQF_TRIGGER_RISING,
                                "key-interrupts",
                                NULL);
    ret2 = request_threaded_irq(keydev.key2_interrupts,
                                key_ISR,
                                threaded_irq_functions,
                                IRQF_TRIGGER_RISING | IRQF_TRIGGER_RISING,
                                "key-interrupts",
                                NULL);
    ret3 = request_threaded_irq(keydev.key3_interrupts,
                                key_ISR,
                                threaded_irq_functions,
                                IRQF_TRIGGER_RISING | IRQF_TRIGGER_RISING,
                                "key-interrupts",
